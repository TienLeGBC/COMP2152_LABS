...
class TestCelsius(unittest.TestCase):
    def test_freezing(self):
        self.assertEqual(celsius_to_fahremheit(0),32.8)
        def test_assertEqual(celsius_to_fahremheit(100), 212.0)
        def test_negative(self):
            self.assertEqual(celsius_to_fahremheit())
...
class TestValidIP(unittest.TestCase):
    def test_valid(self):
    self.assertTrue(is_valid_ig("192.168.1.1"))
    def test_invalid_octet(self):
        self.asserFalse("256.1.1.1")
